...
void main() {
  ...
  testWidgets('Test Splash Screen on small viewport', (
    WidgetTester tester,
  ) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(const SplashScreenTugas12(), size: const Size(320, 568)),
    );
    await tester.pump(const Duration(seconds: 3));
    expect(find.byType(SplashScreenTugas12), findsOneWidget);
  });

  testWidgets('Test Halaman Login on small viewport', (
    WidgetTester tester,
  ) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(const HalamanLoginFodos(), size: const Size(320, 568)),
    );
    expect(find.byType(HalamanLoginFodos), findsOneWidget);
  });

  testWidgets('Test Halaman Pendaftaran on small viewport', (
    WidgetTester tester,
  ) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(
        const HalamanPendaftaranFodos(),
  ...
  testWidgets('Test Bottom Navigation and Home View', (
    WidgetTester tester,
  ) async {
    await tester.binding.setSurfaceSize(const Size(360, 640));
    await tester.pumpWidget(
      createTestWidget(const BottomNavTugas12(), size: const Size(360, 640)),
    );
  ...
  testWidgets('Test HomeFodos View directly', (WidgetTester tester) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(const HomeFodos(), size: const Size(320, 568)),
    );
    expect(find.byType(HomeFodos), findsOneWidget);
  });

  testWidgets('Test DetailMakanan View on narrow screen', (
    WidgetTester tester,
  ) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(
        DetailMakanan(produk: dummyProduk),
        size: const Size(320, 568),
      ),
    );
  ...
  testWidgets('Test HalamanKeranjang View', (WidgetTester tester) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(const HalamanKeranjang(), size: const Size(320, 568)),
    );
  ...
  testWidgets('Test HalamanFavorit View', (WidgetTester tester) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(const HalamanFavorit(), size: const Size(320, 568)),
    );
    await tester.pump(const Duration(seconds: 10));
  ...
  testWidgets('Test PesananTugas12 View', (WidgetTester tester) async {
    await tester.binding.setSurfaceSize(const Size(360, 640));
    await tester.pumpWidget(
      createTestWidget(const PesananTugas12(), size: const Size(360, 640)),
    );
    await tester.pump(const Duration(seconds: 1));
  ...
  testWidgets('Test PesananAktifView View', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      createTestWidget(
        const PesananAktifView(userId: '1'),
        size: const Size(320, 568),
      ),
    );
    await tester.pump(const Duration(seconds: 1));
  ...
  testWidgets('Test ProfileTugas12 View', (WidgetTester tester) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(const ProfileTugas12(), size: const Size(320, 568)),
    );
  ...
  testWidgets('Test InformasiPribadi View', (WidgetTester tester) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(const InformasiPribadi(), size: const Size(320, 568)),
    );
  ...
  testWidgets('Test ProfilAlamat View', (WidgetTester tester) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(const ProfilAlamat(), size: const Size(320, 568)),
    );
  ...
  testWidgets('Test ProfilKeamanan View', (WidgetTester tester) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(const ProfilKeamanan(), size: const Size(320, 568)),
    );
  ...
  testWidgets('Test HalamanPilihLokasi View', (WidgetTester tester) async {
    await tester.binding.setSurfaceSize(const Size(320, 568));
    await tester.pumpWidget(
      createTestWidget(const HalamanPilihLokasi(), size: const Size(320, 568)),
    );
